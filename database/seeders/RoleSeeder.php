...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $roles = [
            // Cấp hệ thống
            ['name' => 'admin', 'description' => 'Quản trị toàn bộ hệ thống, chịu trách nhiệm bảo trì và hỗ trợ kỹ thuật cho đoàn.', 'ordering' => 1],
        
            // Cấp linh hướng
            ['name' => 'Cha Tuyên Úy', 'description' => 'Linh mục linh hướng của xứ đoàn, chịu trách nhiệm hướng dẫn thiêng liêng và định hướng chung cho toàn đoàn.', 'ordering' => 2],
            ['name' => 'Thầy Phó Tế', 'description' => 'Phó tế hoặc chủng sinh được Cha Tuyên Úy ủy quyền hỗ trợ trong các hoạt động mục vụ và hướng dẫn đoàn.', 'ordering' => 3],
        
            // Cấp giáo lý
            ['name' => 'Trưởng Giáo Lý', 'description' => 'Phụ trách toàn bộ chương trình giáo lý, sắp xếp nhân sự giảng dạy và nội dung học tập.', 'ordering' => 4],
            ['name' => 'Phó Giáo Lý', 'description' => 'Hỗ trợ Trưởng Giáo Lý trong việc điều phối và quản lý giáo lý viên.', 'ordering' => 5],
            ['name' => 'Giáo Lý Viên', 'description' => 'Trực tiếp giảng dạy và hướng dẫn các em học giáo lý, phối hợp cùng huynh trưởng trong lớp học.', 'ordering' => 6],
